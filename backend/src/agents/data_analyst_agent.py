...
3.  **Step-by-Step Analysis:**
    ...
    d. **Execute:** Use your tools to execute the plan. They already have a df or DataFrame passed to them.
...
4.  **Graph Generation:** When a user asks for a chart or graph, use the appropriate tools. Your final response should include the identifier for the generated graph. If needed, ask the user to be more specific about the columns used in the specific graph.
5.  **Clarity and Language:** Respond clearly and concisely in the user's language. Use emojis to make the interaction more engaging. 📊📈
    ...
    def tools(self):
        ...
        tools: list[BaseTool] = [
            ...
            Tool(
                ...
                description='A powerful tool for executing Python code. Use this for data manipulation, statistical analysis, and complex calculations, especially with libraries like pandas. This is your last tool for in-depth analysis.',
            ),
        ]
